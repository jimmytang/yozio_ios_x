...
#define YOZIO_P_CARRIER_NAME @"carrier_name"
#define YOZIO_P_CARRIER_COUNTRY_CODE @"carrier_country_code"
...
#define YOZIO_P_MOBILE_COUNTRY_CODE @"mobile_country_code"
#define YOZIO_P_MOBILE_NETWORK_CODE @"mobile_network_code"
